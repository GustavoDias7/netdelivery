"""
Django settings for netdelivery project.
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'netdelivery.context.header',
                'netdelivery.context.contacts'
            ],
        },
    },
]

WSGI_APPLICATION = 'netdelivery.wsgi.application'
...
if not DEBUG:
    ...
    STATICFILES_STORAGE = 'netdelivery.storage_backends.StaticStorage'
    
    # s3 public media settings
    PUBLIC_MEDIA_LOCATION = 'media'
    MEDIA_URL = f'{AWS_S3_CUSTOM_DOMAIN}/{PUBLIC_MEDIA_LOCATION}/'
    DEFAULT_FILE_STORAGE = 'netdelivery.storage_backends.PublicMediaStorage'
else:
    STATIC_URL = 'static/'
    STATICFILES_DIRS = [BASE_DIR / "static"]
